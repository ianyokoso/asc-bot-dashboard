            ...
            case 'submitted':
                return (
                    <div className="flex justify-center items-center w-full h-full">
                        ...
                        <div className="w-5 h-5 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-[0_4px_12px_rgba(16,185,129,0.3)] hover:scale-110 transition-transform duration-300 border border-white/20">
            ...
            case 'missed':
                return (
                    <div className="flex justify-center items-center w-full h-full">
                        ...
                        <div className="w-5 h-5 rounded-full bg-gradient-to-br from-rose-400 to-red-500 flex items-center justify-center shadow-[0_4px_12px_rgba(244,63,94,0.3)] hover:scale-110 transition-transform duration-300 border border-white/20">
